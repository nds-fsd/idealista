            ...
            <div className={styles.form_container}>
                <form style={{ width: "300px" }} onSubmit={handleSubmit(onSubmit)}>
                    <div className={styles.input}>
                        <label>Nombre</label>
                        <br />
                        <input type="text" className={styles.input_text} {...register("name", { required: "El nombre es requerido" })} />
                    ...
                    <div className={styles.check_container}>
                        <input className={styles.check} type="checkbox" id="privacidad" name="privacidad" checked={isPrivacyChecked} onChange={(e) => setIsPrivacyChecked(e.target.checked)} />
                        <Link style={{ textDecoration: "underline", color: "black" }} to="/privacity">
                            <span>Acepto las políticas de privacidad</span>
                        </Link>
                    </div>
                    <div className={styles.check_container}>
                        <input className={styles.check} type="checkbox" id="informacion" name="informacion" checked={isInfoChecked} onChange={(e) => setInfoChecked(e.target.checked)} />
