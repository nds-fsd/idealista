...
export const CreateRealEstate = async (data) => {
    try {
        ...
        console.log("Coordenadas:", coordinates, publicCoordinates, coordinates.length, publicCoordinates.length)
        ...
        console.log("data:", data.realposition, data.publicposition, data)
